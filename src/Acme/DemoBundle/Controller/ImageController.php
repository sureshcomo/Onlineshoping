...
class ImageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AcmeDemoBundle:Image')->findAll();
     ...
     * @Method("POST")
     * @Template("AcmeDemoBundle:Image:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AcmeDemoBundle:Image')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AcmeDemoBundle:Image:edit.html.twig")
     */
